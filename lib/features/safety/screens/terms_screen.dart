...
/// Términos y Condiciones + Política de Privacidad — borrador para ServiciosYa
///
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildSection(
                    ...
                    'ServiciosYa es una plataforma tecnológica que conecta a personas que ofrecen servicios del hogar (Prestadores) con personas que los necesitan (Clientes). ServiciosYa actúa exclusivamente como intermediario tecnológico y NO es empleador, contratista, ni empresa de servicios respecto de los Prestadores. La relación de servicio se acuerda directamente entre Cliente y Prestador; ServiciosYa no es parte de ese contrato.',
                  ),
                  _buildSection(
                    '2. Registro y elegibilidad',
                    'Para usar la plataforma debes ser mayor de 18 años, tener capacidad legal, y proporcionar información veraz. Al registrarte declaras que los datos que suministras son ciertos y actualizados. ServiciosYa puede suspender o eliminar cualquier cuenta con información falsa, duplicada o utilizada para fines ilícitos, sin necesidad de aviso previo.',
                  ),
                  _buildSection(
                  ...
                  _buildSection(
                    ...
                    'ServiciosYa cobra una comisión total del 10% sobre el precio base del servicio, dividida en:\n\n'
                    '• Un 5% de "Garantía ServiciosYa" pagado por el Cliente adicional al precio base.\n'
                    ...
                    'Los pagos se procesan mediante procesadores autorizados. ServiciosYa NO almacena datos de tarjetas de crédito o débito en sus servidores; estos datos residen únicamente en el procesador de pagos correspondiente, conforme a los estándares PCI-DSS.',
                  ),
                  _buildSection(
                    ...
                    '• Si el Prestador no se presenta o cancela sin causa justificada, ServiciosYa reembolsará al Cliente el 100% pagado y podrá aplicar sanciones al Prestador.',
                  ),
                  _buildSection(
                    '7. Sistema de mediación de disputas',
                    'En caso de conflicto entre las partes, ServiciosYa ofrece un proceso de mediación con las siguientes etapas: (a) reporte del incidente por cualquiera de las partes; (b) recolección de evidencia (fotos, chat, historial); (c) resolución emitida por el equipo de moderación de ServiciosYa dentro de 5 días hábiles. Ambas partes reconocen esta mediación como paso previo obligatorio a cualquier reclamación ante las autoridades competentes. La resolución no es vinculante judicialmente pero puede ser usada como evidencia.',
                  ),
                  _buildSection(
                  ...
                  _buildSection(
                    ...
                    'Salvo dolo o culpa grave, ServiciosYa no responde por: daños derivados de la relación entre Cliente y Prestador, interrupciones del servicio por fuerza mayor o mantenimiento, errores u omisiones de los usuarios, o pérdidas indirectas. En ningún caso la responsabilidad total de ServiciosYa excederá el monto de la comisión percibida por la operación en disputa.',
                  ),
                  _buildSection(
                    '10. Modificaciones y jurisdicción',
                    'ServiciosYa se reserva el derecho de modificar estos términos. Los cambios sustanciales serán notificados con al menos 15 días de anticipación por medio de la app o el correo registrado. El uso continuado tras la fecha de vigencia constituye aceptación de los nuevos términos.\n\n'
                  ...
                  _buildSection(
                    ...
                    'ServiciosYa (en adelante, "el Responsable") es la entidad responsable del tratamiento de los datos personales recopilados a través de la plataforma. Contacto para asuntos de privacidad: privacidad@serviciosya.do. Puedes ejercer tus derechos ARCO (Acceso, Rectificación, Cancelación, Oposición y Portabilidad) escribiendo a esa dirección.',
                  ),
                  _buildSection(
                  ...
                  _buildSection(
                    ...
                    '• OPOSICIÓN: negarte a tratamientos específicos escribiendo a privacidad@serviciosya.do.\n'
                  ...
                  const Text(
                    'Para consultas sobre privacidad escribe a privacidad@serviciosya.do',
                    style: TextStyle(
                        fontSize: 12, color: AppColors.textHint),
                  ),
                  const SizedBox(height: 32),
                  ...
                  GestureDetector(
                    ...
                    child: Row(
                      children: [
                        ...
                        const Expanded(
                          child: Text(
                            'He leído y acepto los Términos y Condiciones y la Política de Privacidad de ServiciosYa. Doy mi consentimiento libre, expreso e informado para el tratamiento de mis datos personales conforme a la Ley 172-13.',
                            style: TextStyle(
